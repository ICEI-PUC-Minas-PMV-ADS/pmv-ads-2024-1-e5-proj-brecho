        ...
        <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="/auth/login">
                    ...
                    <button type="submit" class="w-full text-white font-bold bg-blue-600 hover:bg-primary-700 focus:ring-2 focus:outline-none focus:ring-primary-300 rounded-lg text-sm px-5 py-2.5 text-center">Login</button>
                    <p class="text-sm text-gray-500">
                        Não possui conta? <a href="/auth/register" class="font-medium text-blue-600 hover:underline">Registre-se</a>
                    </p>
                </form>
            </div>
        </div>
